...
def record_audio(duration=2.0, fs=22050):
    ...
    Returns: fs, numpy array of audio
    """
...
def save_wav_from_array(path, fs, audio_array):
    """
...
st.markdown("This app predicts the alphabet by frequency, so it can sometimes make mistakes— Made with ❤️ — Haruf-e-Tahajji Kids Trainer.")
...
# -----------------------
    ...
    if not st.session_state.premium:
        ...
        st.info("Please unlock from **Parents** section")
        st.stop()
